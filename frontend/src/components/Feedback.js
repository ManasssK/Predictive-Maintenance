        ...
        <div className="flex justify-center items-center ">
            ...
            <h1 className="text-3xl text-center ">Feedback</h1>
                <div class="mb-6 mt-12 flex justify-center items-center">
                    ...
                    <input type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" value={feedbackMessage} onChange={handleChange} />
                </div>

                <br />
                <button type="button" class="text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-pink-600 dark:hover:bg-pink-700 focus:outline-none dark:focus:ring-pink-800 text-center" onClick={handleSubmit}>Submit</button>
